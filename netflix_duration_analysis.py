...
figure_1=plt.plot(durations_df["years"],durations_df["durations"])
...
figure_2=plt.scatter(netflix_movies_col_subset["release_year"],netflix_movies_col_subset["duration"])

# Create a title
plt.title("Movie Durations by Year of Release")
...
figure_3=plt.scatter(netflix_movies_col_subset["release_year"],netflix_movies_col_subset["duration"],color=colors)
...
#necessarily, certainly a lot more movies have been produced in the last years but we can't say for certain that duration has decreased over time"
